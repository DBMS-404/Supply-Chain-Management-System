        ...
        <div class="container py-5">
            <div class="row mb-3">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 class="fw-bold"><i class="fa fa-sign-in" aria-hidden="true"></i>  Login to Continue...</h2>
                </div>
            </div>
                    ...
                    <div><a href="#"><img class="rounded img-fluid shadow w-100 fit-cover" src="https://www.getmax.ae/wp-content/uploads/2021/07/Supply-chain-managemetn.svg" height="150px" /></a>
                        <div class="py-4">
                            <form class="p-3 p-xl-4" action="<?= SROOT ?>LoginHandler/login" method="post">
                                ...
                                <div class="mb-3">
                                    <input type="password" class="form-control" placeholder="Password" name="password"> <span class="error">
                                </div>
